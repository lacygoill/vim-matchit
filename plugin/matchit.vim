...
nno <silent> %      :<c-u>call matchit#wrapper('', 1, 'n')<cr>
nno <silent> g%     :<c-u>call matchit#wrapper('', 0, 'n')<cr>
...
nno <silent> [%     :<c-u>call matchit#multi('bW', 'n')<cr>
nno <silent> ]%     :<c-u>call matchit#multi('W',  'n')<cr>
xmap         [%     <esc>[%m'gv``
xmap         ]%     <esc>]%m'gv``
