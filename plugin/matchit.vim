...
nno <silent> %      :<c-u>let g:motion_to_repeat = '%'  <bar> call matchit#next_item(1, 'n')<cr>
nno <silent> g%     :<c-u>let g:motion_to_repeat = 'g%' <bar> call matchit#next_item(0, 'n')<cr>

xno <silent> %      :<c-u>call matchit#next_item(1, 'v')<cr>m'gv``
xno <silent> g%     :<c-u>call matchit#next_item(0, 'v')<cr>m'gv``

ono <silent> %     v:<c-u>call matchit#next_item(1, 'o')<cr>
ono <silent> g%    v:<c-u>call matchit#next_item(0, 'o')<cr>
